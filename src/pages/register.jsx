...
export default function Register() {
  ...
  const validate = () => {
    ...
    else if (form.password.length < 4) e.password = "يجب أن تكون 4 أحرف على الأقل";
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-500 text-sm mt-1">أنشئ حسابك وابدأ التتبع</p>
          </div>
          ...
          <div className="bg-white/[0.03] border border-white/8 rounded-3xl p-8 space-y-5">
            ...
            {/* <Field label="تأكيد كلمة المرور" icon={Lock} error={errors.confirm}>
              <div className="relative">
                <input
                  type={showConfirm ? "text" : "password"}
                  className={inputCls(!!errors.confirm) + " pr-4 pl-10"}
                  value={form.confirm}
            ...
            <p className="text-center text-sm text-zinc-500">
              لديك حساب بالفعل؟{" "}
              <NextLink
                href={`/login${router.query.back ? "?back=" + router.query.back : ""}`}
